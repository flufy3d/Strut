    ...
    return Backbone.View.extend({
      ...
      render: function() {
        ...
        if (this.options.tag === "video") {
          this.$el.find(".modal-body").prepend("<div class='alert alert-success'>Supports <strong>webm & YouTube & YouKu</strong>.<br/>Try out: http://www.youtube.com/watch?v=vHUsdkmr-SM</div>");
        }
